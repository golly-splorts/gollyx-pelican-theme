...
pelican-themes -i gollyx-vi-pelican-theme

# If theme is installed, update it
pelican-themes -U gollyx-vi-pelican-theme
```

## Usage

To use this Pelican theme, set the theme to `gollyx-vi-pelican-theme`
in `pelican.conf`.
